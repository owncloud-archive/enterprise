...
This is our ownCloud image for the enterprise edition, it is based on our [base container](https://registry.hub.docker.com/u/owncloud/base/). Additionally we have preinstalled the richdocuments app. This ownCloud server is designed to work with a data volume in the host filesystem and with separate MariaDB and Redis containers.
...
* [10.0.1](https://github.com/owncloud-docker/enterprise/tree/10.0.1) available as ```owncloud/enterprise:10.0.1```
* [10.0.1RC5](https://github.com/owncloud-docker/enterprise/tree/10.0.1RC5) available as ```owncloud/enterprise:10.0.1RC5```
* [10.0.1RC4](https://github.com/owncloud-docker/enterprise/tree/10.0.1RC4) available as ```owncloud/enterprise:10.0.1RC4```
* [10.0.1RC3](https://github.com/owncloud-docker/enterprise/tree/10.0.1RC3) available as ```owncloud/enterprise:10.0.1RC3```
* [10.0.1RC2](https://github.com/owncloud-docker/enterprise/tree/10.0.1RC2) available as ```owncloud/enterprise:10.0.1RC2```
* [10.0.1RC1](https://github.com/owncloud-docker/enterprise/tree/10.0.1RC1) available as ```owncloud/enterprise:10.0.1RC1```
* [10.0.0](https://github.com/owncloud-docker/enterprise/tree/10.0.0) available as ```owncloud/enterprise:10.0.0```
* [10.0.0RC5](https://github.com/owncloud-docker/enterprise/tree/10.0.0RC5) available as ```owncloud/enterprise:10.0.0RC5```
* [10.0.0RC4](https://github.com/owncloud-docker/enterprise/tree/10.0.0RC4) available as ```owncloud/enterprise:10.0.0RC4```
* [10.0.0RC3](https://github.com/owncloud-docker/enterprise/tree/10.0.0RC3) available as ```owncloud/enterprise:10.0.0RC3```
* [10.0.0RC2](https://github.com/owncloud-docker/enterprise/tree/10.0.0RC2) available as ```owncloud/enterprise:10.0.0RC2```
* [10.0.0RC1](https://github.com/owncloud-docker/enterprise/tree/10.0.0RC1) available as ```owncloud/enterprise:10.0.0RC1```
* [10.0.0beta2](https://github.com/owncloud-docker/enterprise/tree/10.0.0beta2) available as ```owncloud/enterprise:10.0.0beta2```
...
* [9.1.5](https://github.com/owncloud-docker/enterprise/tree/9.1.5) available as ```owncloud/enterprise:9.1.5```
...
* [9.0.9](https://github.com/owncloud-docker/enterprise/tree/9.0.9) available as ```owncloud/enterprise:9.0.9```
